  ...
  return (
    <div className="min-w-[300px] p-4 bg-white">
      ...
      <div className="space-y-4">
        <Toggle label="Search in Query Values" enabled={true} setEnabled={() => { }} />
        <Toggle label="Search in Path" enabled={true} setEnabled={() => { }} />
        <Toggle label="Search for null/undefined" enabled={true} setEnabled={() => { }} />
      </div>
      <hr className="my-4"/>
      <div className="space-y-4">
        <Toggle label="Partial Matching" enabled={true} setEnabled={() => { }} />
        <Toggle label="Clear Findings on Refresh" enabled={true} setEnabled={() => { }} />
      </div>
      <hr className="my-4"/>
      <button
        type="button"
